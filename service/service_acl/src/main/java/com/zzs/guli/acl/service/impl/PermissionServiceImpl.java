...
import com.zzs.guli.acl.entity.Permission;
import com.zzs.guli.acl.entity.RolePermission;
import com.zzs.guli.acl.entity.User;
import com.zzs.guli.acl.helper.MenuHelper;
import com.zzs.guli.acl.helper.PermissionHelper;
import com.zzs.guli.acl.mapper.PermissionMapper;
import com.zzs.guli.acl.service.PermissionService;
import com.zzs.guli.acl.service.RolePermissionService;
...
//        //存放level 2 的 数据  作为二级菜单
//        permissionNode.setChildren(new ArrayList<>());
//
//        for(Permission it :permissionList){
//
//            if (permissionNode.getPid().equals(it.getPid())){
